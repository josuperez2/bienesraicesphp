...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //validaciones
    if (!$titulo) {
        $errores[] = "Debes añadir el título de la propiedad";
    }
    ...
    //validar tamaño imagen max 1MB
    $medida = 1000 * 1000;

    if ($imagen['size'] > $medida) {
        $errores[] = "La imagen de la propiedad debe tener un tamaño máximo de 1MB";
    }
    ...
    if (empty($errores)) {
        ...
        $query = "INSERT INTO propiedades (titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, vendedores_Id, creado) VALUES (
            '$titulo',
            '$precio', //
            '$nombreImagen',
            '$descripcion',
        ...
        if ($resultado) {
            //redireccionar al usuario a la página principal con resultado=1
